...
You can make easy-to-restore backups over [SSH](/user-docs/services/shell/) by
...
Instructions are on the [MySQL](/user-docs/services/mysql/) page, but the basic syntax
to make a backup is
...
[follow our instructions](/user-docs/services/mysql/) to create `~/.my.cnf` which will
